...
# -----------------------------------------------------
# SUBJECT MODEL (Belongs to Class)
# -----------------------------------------------------
class Subject(models.Model):
...
# -----------------------------------------------------
# ASSIGN SUBJECT MODEL (Teacher → Subject → Class)
# -----------------------------------------------------
class AssignSubject(models.Model):
    teacher = models.ForeignKey(ser, on_delete=models.CASCADE, limit_choices_to={'role': 'teacher'})
    class_room = models.ForeignKey(ClassRoom, on_delete=models.CASCADE)
