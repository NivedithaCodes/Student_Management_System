...
class AssignSubject(models.Model):
    ...
    assigned_class = models.ForeignKey(ClassRoom, on_delete=models.CASCADE,related_name='subjects',null=True,blank=Tru)
    ...
    # def __str__(self):
    #     if self.subject:
    #         return f"{self.subject.subject_name} - {self.assigned_class}"
    #     return "Unassigned Subject"

    def __str__(self):
        if self.subject and self.assigned_class:
           return f"{self.subject.subject_name} - {self.assigned_class}"
        elif self.subject:
           return f"{self.subject.subject_name} - Unassigned Class"
        return "Unassigned Subject"
