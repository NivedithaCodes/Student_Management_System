...
from .views import home_view,login_view,signup_view,student_view,parent_view,teacher_view,principal_view,logout_view,add_admin,add_student,add_teacher,edit_user,
