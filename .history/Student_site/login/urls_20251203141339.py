...
urlpatterns = [
    ...
    path("edit-subject-base/<int:id>/", views.edit_subject_base),
    path("delete-subject-base/<int:id>/", views.delete_subject_base),

    # AssignSubject Management
    path('assign-subject/', views.assign_subject, name='add_subject'),
