...
def add_class(request):
    ...
    if request.method == "POST":
        ...
        class_teach = user.objects.get(id=teacher_id) if teacher_id else None
        ClassRoom.objects.create(class_name=class_name, section=section,max_strength=max_strength,class_teacher=teacher_obj)
