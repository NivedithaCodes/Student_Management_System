...
def add_class(request):
    use_teacher= user.objects.filter(role='teacher')
    if request.method == "POST":
        ...
        ClassRoom.objects.create(class_name=class_name, section=section,max_strength=max_strength,users_teacher=users_teacher)
