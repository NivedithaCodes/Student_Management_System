...
#     print("Stored password in DB:", u.password)
...
#         # 1️⃣ Check old password is correct
...
#         # 5️⃣ Destroy session & force re-login
#         request.session.flush()
...
def teacher_view(request):
    ...
    return render(request, "Teacher_Pages/teacher_page.html", context)
