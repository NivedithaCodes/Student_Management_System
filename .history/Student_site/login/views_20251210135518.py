...
#     Q(id__in=subject_class_ids) |
#     Q(id=class_teacher_class.id if class_teacher_class else None)
#     ).distinct()
...
from .models import user, ClassRoom, AssignSubject
...
def view_students(request):
    ...
    # For class teacher: fetch their class
    ...
    # For subject teacher: fetch students of assigned classes
    assigned_classes = ClassRoom.objects.filter(
    ...
    if filter_class:
        subject_teacher_students = subject_teacher_students.filter(
