...
def view_students(request):
    ...
    if filter_class:
    class_teacher_students = class_teacher_students.filter(class_name_id=int(filter_class))
    subject_teacher_students = subject_teacher_students.filter(class_name_id=int(filter_class))
